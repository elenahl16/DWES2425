    ...
    <form action="" method="post">
        <fieldset>
            <div>
                ...
                <input type="date" id="fecha_entrada" name="fecha_entrada value=" <?php  (isset($_POST['fecha_entrada'])?$_POST['fecha_entrada']:date('Y-m-d')) ?>"></input>
                <br></br>
            </div>

            <div>
                <label form="nombreC">Cliente</label>
                <input type="text" name="nombreC" id="nombreC" placeholder="Nombre del Cliente"
                value=" <?php echo (isset($_POST['nombreC'])?$_POST['nombreC']:'') ?>"></input>
            </div>
