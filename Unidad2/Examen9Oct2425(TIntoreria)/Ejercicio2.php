<?php
// esta función ayuda a seleccionar una opción en un elemento <select> ()
// La función toma dos parámetros: el valor que queremos comparar ($valor) y si es el valor por defecto ($defecto)
