...
<body>
    ...
    if (isset($_POST['guardar'])) {
        ...
        if(!isset($error)){
            ...
            //Creamos la intancias de los objeto de la clase modelo y trabajo
            $m = new Modelo();
            $t = new Trabajo($_POST['fecha'],$_POST['nombre']
                 ,$_POST['tipo'],implode('/',$_POST['servicios']),$_POST['importe']);
            
            //aqui lo que hacemos es llamamos al metodo guardar trabajo donde nos va almacenar los datos en un fichero
